...
FOUNDATION_EXPORT double A2ISurveyFrameworkVersionNumber;

//! Project version string for A2ISurveyFramework.
FOUNDATION_EXPORT const unsigned char A2ISurveyFrameworkVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <A2ISurveyFramework/PublicHeader.h>
